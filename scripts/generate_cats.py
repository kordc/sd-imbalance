...
cat_modifiers = [
    "realistic", "detailed", "simple", "studio quality", "professional",
    "photorealistic", "high resolution", "clear", "sharp focus", "natural light",
    "soft light", "cinematic", "close-up", "full body", "adorable",
    "fluffy", "sleek", "sitting", "sleeping", "looking at camera",
    "illustration style", "painted", "sketch style" # Added some style variations
]
...
def make_img(folder: str = "./tmp", num_images=10000, modifier_list=None) -> None:
    ...
    for i in tqdm(range(num_images), desc="Generating Images"):
        ...
        try:
            ...
            # Define output path
            output_path = os.path.join(output_dir, f"{i:05d}_cat_{selected_modifier.replace(' ','_')}.png") # Added modifier to filename
